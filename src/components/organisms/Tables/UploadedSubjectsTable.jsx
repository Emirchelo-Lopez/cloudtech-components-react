function UploadedSubjectsTable() {
  return (
    <div>
      <table className="uploaded-subjects-table">
        ...
        <tr className="table-row">
          <td>
            <span>Tópicos Avanzados de Programación</span>
            <span>Wendy Carranza Díaz</span>
          </td>
          <td>8:00 - 9:00</td>
          <td>8:00 - 9:00</td>
          <td>8:00 - 9:00</td>
        ...
        <tr className="table-row shaded-row">
          <td>
            <span>Tópicos Avanzados de Programación</span>
            <span>Wendy Carranza Díaz</span>
          </td>
...
export default UploadedSubjectsTable;
